      ...
      >
        ...
        <ReporterRead
          ...
          notes={[
            ...
            `${formatCount(signals.length, "related signal")}: ${formatCount(signalCounts.filings, "filing")}, ${formatCount(signalCounts.committees, "new-committee record")}, ${formatCount(signalCounts.outsideSpending, "outside-spending alert")}; ${formatCount(signalCounts.review, "signal")} flagged for editor review.`,
            incumbentCount

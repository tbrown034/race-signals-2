...
create index if not exists signals_type_date_idx on signals(signal_type, signal_date desc, created_at desc);
create index if not exists signals_type_amount_date_idx on signals(signal_type, amount desc, signal_date desc);
create index if not exists signals_status_date_idx on signals(status, signal_date desc, created_at desc);
create index if not exists signals_race_type_date_idx on signals(race_id, signal_type, signal_date desc, created_at desc);

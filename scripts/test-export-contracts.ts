...
const scheduleERow: ScheduleEExportRow = {
  ...
  payee_name: "MAIN STREET MEDIA GROUP",
  category_code_full: "Advertising Expenses",
  filing_form: "24",
  file_number: "1800000",
  pdf_url: "https://docquery.fec.gov/pdf/000/1800000/1800000.pdf",
  ...
  candidate_incumbent_challenge_status: "I",
  candidate_context: "REP, IN-05, incumbent",
...
assert.equal(
  scheduleEToExportRow({
    ...
    disseminationDate: "2026-05-21",
    payeeName: "MAIN STREET MEDIA GROUP",
    categoryCodeFull: "Advertising Expenses",
    filingForm: "24",
    fileNumber: "1800000",
    pdfUrl: "https://docquery.fec.gov/pdf/000/1800000/1800000.pdf",
    purpose: "+Digital ads",

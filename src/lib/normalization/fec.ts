...
export function normalizeIndependentExpenditure(
  ...
  return {
    ...
    disseminationDate: record.dissemination_date ?? null,
    payeeName: record.payee_name ?? null,
    categoryCodeFull: record.category_code_full ?? null,
    filingForm: record.filing_form ?? null,
    fileNumber: record.file_number === undefined || record.file_number === null ? null : String(record.file_number),
